...
int main() {
    ...
    if (role == 1) {
        ...
        do {
            ...
            cin >> choice;
            switch (choice) {
            case 1: employeeHandle(); break;
            case 2: benefitsHandle(); break;
            case 3: departHandle(); break;
            case 4: salaryHandle(); break;
            case 5: hr->employeeReporting(); break;
            case 6: searchHandle(); break;
            case 7: recruitmentHandle(); break;
            case 0: break;
...
//    int choice;
//    int loginType;
//    cout << "Login as: [1] HR, [2] Recruit: ";
//    cin >> loginType;
//
//    do
//    {
//        system("cls");
//        system("color 0F"); // Text color: Black
//        cout << "\t\t\t------------------------------------" << endl;
//        cout << "\t\t\t\033[1;34m|--    HR MANAGEMENT SYSTEM    ----|\033[0m" << endl;
//        cout << "\t\t\t------------------------------------" << endl;
//        cout << "\t\t\t\033[1;33m[1] Employee Information Management\033[0m" << endl; 
